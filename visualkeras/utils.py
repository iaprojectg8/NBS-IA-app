...
def vertical_image_concat(im1: Image, im2: Image, padding, background_fill: Any = 'white'):
    """
    ...
    """
    dst = Image.new('RGBA', (max(im1.width, im2.width), im1.height + im2.height+padding), background_fill)
    dst.paste(im1, (0, padding))
