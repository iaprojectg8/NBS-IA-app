...
def layered_view(model, to_file: str = None, min_z: int = 20, min_xy: int = 20, max_z: int = 400,
    ...
    if legend:
        ...
        text_height = int(font.getlength("Ag","ttb"))
        ...
        for layer_type in layer_types:
            ...
            text_size = int(font.getlength(label,"rtl"))
        ...
        legend_image = linear_layout(patches, max_width=img.width, max_height=img.height, padding=padding, spacing=spacing,
                                     background_fill=background_fill, horizontal=False)
        img = vertical_image_concat(img, legend_image,padding=padding, background_fill=background_fill)
